...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        /// <summary>
        /// Sends an event to be tracked
        /// </summary>
        /// <param name="extras"></param>
        public void Gameboardlytics_SendEvent(string eventType, string extras)
        {
            AndroidJavaClass gameboardlytics = new AndroidJavaClass("com.lastgameboard.gameboardlytics.GameboardlyticsHelper");
            gameboardlytics.CallStatic("sendEvent", config.androidApplicationContext.GetNativeContext(), eventType, extras);
        }
        #endregion
    }
}