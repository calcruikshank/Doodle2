...
namespace Gameboard
{
    ...
    public class CardController : MonoBehaviour
    {
        ...
        /// <remarks>
        /// You are able to set some of the preset assets on the companion app defined by the values in ControlAssetType.
        /// Possible assets to be set include the start/end buttons on either side of the hand
        /// the background image behind the cards, and the selected card indicator.
        /// 
        /// Aspect ratios ideally should be as follows for the card control assets, if they do not match then they will be stretched:
        /// StartControl/EndControl - 5:17
        /// Background - 16:9 ratio, at least 400px at its shortest dimension.
        /// 
        /// Selected Asset/Highlight Asset:
        ///     Same as the card for your current template, this asset is placed on top of the center card/highlighted card.
        ///     Use transparency to have the desired affect appear on top of the card.
        /// </remarks>
        /// <returns></returns>
        ...
        /// <returns>Task<CompanionCreateObjectEventArgs></returns>
        /// <remarks>
        /// This requires the card asset to be previously loaded to the companion
        /// Cards will keep aspect ratio if using non-recommended aspect ratio
        ///     If the card is in a different aspect ratio, the side that is smaller will stretch the edge of the image to the edge of the space.Use transparency if this is not desired.
        /// If you are using the card template on the companion app then the recommended aspect ratio is 6:7
        /// If you are using the tile template on the companion app then the recommended aspect ratio is 1:1
        /// </remarks>
